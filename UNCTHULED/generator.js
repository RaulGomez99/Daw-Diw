    ...
    switch (columnasArray[coordenadaColumna(x,y)]) {
        ...
        case "momia":
            ...
            setTimeout(function(){
                ...
                intervals[monstruos.length-1] = window.setInterval(function(){iaMomia(monstruos[monstruos.length-1])},400);
...
function crearMapa() {
    ...
    for(let i=0; i<momias; i++){
        ...
        intervals[i]=window.setInterval(function(){iaMomia(monstruos[i])},400);
    }
